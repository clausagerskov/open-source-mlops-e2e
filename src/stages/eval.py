...
def eval(params):
    ...
    #y_prob = y_prob[:, 1]
    y_pred = y_prob >= 0.5  # should not be hardcoded
    ...
    out_feat_names = model[:-1].get_feature_names_out(feat_cols)  # is there a way of getting this model element by name instead of slicing?
